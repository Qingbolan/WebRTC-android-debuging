...
import net.qingbolan.webrtcmeeting.adapter.EntityListAdapter;
import net.qingbolan.webrtcmeeting.bean.EntityInfo;
import net.qingbolan.webrtcmeeting.bean.RoomInfo;
import net.qingbolan.webrtcmeeting.bean.RoomSet;
import net.qingbolan.webrtcmeeting.util.SocketUtil;
import net.qingbolan.webrtcmeeting.widget.InputDialog;

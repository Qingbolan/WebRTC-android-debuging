...
import net.qingbolan.webrtcmeeting.bean.ContactInfo;
import net.qingbolan.webrtcmeeting.bean.JoinInfo;
import net.qingbolan.webrtcmeeting.bean.MessageInfo;
import net.qingbolan.webrtcmeeting.constant.ChatConst;
import net.qingbolan.webrtcmeeting.util.ChatUtil;
import net.qingbolan.webrtcmeeting.util.DialogUtil;
import net.qingbolan.webrtcmeeting.util.SocketUtil;
import net.qingbolan.webrtcmeeting.util.ViewUtil;
import net.qingbolan.webrtcmeeting.webrtc.Peer;
import net.qingbolan.webrtcmeeting.webrtc.ProxyVideoSink;
import net.qingbolan.webrtcmeeting.widget.RewardView;
